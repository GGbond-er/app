...
<style>
    .main-header {
        ...
        color: #1f77b4;
        text-align: center;
        /* 将标题再下移一些：将上边距调大到 3.25rem */
        margin: 3.25rem 0 1rem 0;
        scroll-margin-top: 4rem; /* 锚点跳转时也避免被顶栏遮挡 */
    }
    .sub-header {
        font-size: 1.2rem;
        color: #2ca02c;
    ...
    .qa-tagline {
        ...
        font-size: 0.95rem;
        font-weight: 600;
        margin: -0.25rem 0 1rem 0; /* 与标题间距更紧凑些 */
    }
    /* 侧边栏品牌区域：水平居中对齐 */
    .sidebar-brand {
        display: flex;
    ...
    /* 欢迎页标题图片：绝对居中，并向下移动避免遮挡 */
    .home-title {
        display: flex;
        justify-content: center;
        margin: 1.5rem 0 1rem 0;  /* 下移，避免被顶部遮挡 */
        width: 100%;
...
page = st.sidebar.radio("选择页面", [PAGE_WELCOME, PAGE_DATA, PAGE_QA])
