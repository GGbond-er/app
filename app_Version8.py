...
<style>
    .main-header {
        ...
        color: #1f77b4;
        text-align: center;
        margin: 1.75rem 0 1rem 0;  /* 上边距加大，避免被顶部遮挡 */
    }
    .sub-header {
        font-size: 1.2rem;
        color: #2ca02c;
    ...
    .home-title {
        ...
        margin: 1.5rem 0 1rem 0;  /* 已下移，避免被顶部遮挡 */
        width: 100%;
    }
    .home-wenzi {
...
if page == PAGE_WELCOME:
    ...
    # 欢迎页图片区（使用 use_container_width，避免弃用警告）
    try:
